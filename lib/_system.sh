...
apt install -y ffmpeg ufw apt-transport-https software-properties-common curl libgbm-dev wget unzip fontconfig locales libatk1.0-0 libc6 libcairo2 libcups2 libdbus-1-3 libexpat1 libfontconfig1 libgcc1 libgdk-pixbuf2.0-0 libglib2.0-0 libgtk-3-0 libnspr4 libpango-1.0-0 libpangocairo-1.0-0 libstdc++6 libx11-6 libx11-xcb1 libxcb1 libxcomposite1 libxcursor1 libxdamage1 libxext6 libxfixes3 libxi6 libxrandr2 libxrender1 libxss1 libxtst6 ca-certificates fonts-liberation libnss3 lsb-release xdg-utils build-essential libxshmfence-dev unzip fail2ban
EOF
...
apt -y update
apt install -y bash sudo curl
apt install -y ufw apt-transport-https software-properties-common curl wget locales ca-certificates unzip fail2ban
EOF
